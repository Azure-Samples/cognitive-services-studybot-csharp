...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class NlpDispatchBot : IBot
    {
        ...
        /// </summary>
        public static readonly string QnAMakerChitchat = "Chitchat-Shell";
        ...
        private const string WelcomeText = "Welcome to Study Bot! Type a study term you'd like to know more about, such as 'virus'.";
        ...
        private async Task DispatchToTopIntentAsync(ITurnContext context, (string intent, double score)? topIntent, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            const string chitchatDispatchKey = "Chitchat-Shell";
            ...
            {
                case noneKey:
                    await DispatchToLuisModelAsync(context, DispatchKey);
                    break;
